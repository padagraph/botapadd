...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aE, request.F, true);
		} catch (e) {
...
var $author$project$Main$GotRecord = function (a) {
	return {$: 0, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{au: false, aw: r.aw, az: r.az, V: r.V, aE: r.aE, aO: r.aO, ar: r.ar, F: r.F}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aw: $elm$http$Http$emptyBody, az: r.az, V: _List_Nil, aE: 'GET', aO: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, F: r.F});
};
var $author$project$Main$Record = F4(
	function (id, title, items, selected) {
		return {X: id, Y: items, v: selected, aq: title};
	});
var $elm$core$Set$Set_elm_builtin = $elm$core$Basics$identity;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$FileItem = F2(
	function (name, url) {
		return {G: name, F: url};
	});
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$fileDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$FileItem,
...
var $author$project$Main$recordDecoder = A5(
	...
	$elm$json$Json$Decode$succeed($elm$core$Set$empty));
var $author$project$Main$fetchRecord = function (recordID) {
	return $elm$http$Http$get(
		{
			az: A2($elm$http$Http$expectJson, $author$project$Main$GotRecord, $author$project$Main$recordDecoder),
			F: 'https://zenodo.org/api/records/' + recordID
		});
};
var $author$project$Main$init = function (recordId) {
	return _Utils_Tuple2(
		$author$project$Main$Loading(recordId),
		$author$project$Main$fetchRecord(recordId));
};
		...
		switch (msg.$) {
			case 0:
				...
				if (!result.$) {
					var record = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Loaded(record),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						$author$project$Main$Failure('http error'),
						$elm$core$Platform$Cmd$none);
				}
			case 1:
				var i = msg.a;
				if (model.$ === 1) {
					var r = model.a;
					var selection = A2($elm$core$Set$insert, i, r.v);
					return _Utils_Tuple2(
			...
			case 2:
				...
				if (model.$ === 1) {
					var r = model.a;
					var selection = A2($elm$core$Set$remove, i, r.v);
					return _Utils_Tuple2(
						$author$project$Main$Loaded(
							_Utils_update(
								r,
				...
				if (model.$ === 1) {
					...
					var txt = A2(
						...
						A2(
							...
							$elm$core$Set$toList(r.v)));
					return _Utils_Tuple2(
						model,
						A3($elm$file$File$Download$string, 'composition.txt', 'plain/text', txt));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$DownloadComposition = {$: 3};
var $author$project$Main$Uncheck = function (a) {
	return {$: 2, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('ui left aligned text container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Index of a Zenodo record')
							])),
						A2(
						$elm$html$Html$h2,
						_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Available Files')
							]))
					])),
				A2(
				$elm$html$Html$table,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('ui compact table')
					]),
				_List_fromArray(
					[
						A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$href(i.F)
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(i.G)
														]))
												])),
											A2(
											$elm$html$Html$td,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$href('/zenodo/' + (record.X + ('/' + i.G)))
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(i.G)
												...
												[
													...
													_List_fromArray(
														[
															...
															function (b) {
																return b ? $author$project$Main$Check(i.F) : $author$project$Main$Uncheck(i.F);
															})
														]),
													_List_Nil)
												]))
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$DownloadComposition)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Download composition file')
					]))
			]));
};
	...
	switch (model.$) {
		case 0:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Loading ' + id)
					]));
		case 1:
			var record = model.a;
			return $author$project$Main$viewRecord(record);
		default:
			var msg = model.a;
			return A2(
				$elm$html$Html$div,
