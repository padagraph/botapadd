...
@app.route('/wiki-cillex', methods=['GET'])
def wiki_cillex():
    return render_template('wikicillex.html', uuid=uuid("wikicillex"))
...
@app.route('/wikibioapi/<string:lang>/<string:q>', methods=['GET'])
def wikibioapi(lang, q):
    if lang == "en":
        r = query_wikibios_en(q)
    elif lang == "zh":
